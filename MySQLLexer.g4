...
DOT_IDENTIFIER
    : DOT_SYMBOL LETTER_WHEN_UNQUOTED_NO_DIGIT LETTER_WHEN_UNQUOTED* { self.emitDot(); } -> type(IDENTIFIER)
    ;
...
BIT_AND_SYMBOL
    : B I T '_' A N D                                                                     { self.doBitAnd(); }
    ;                                                                                     // MYSQL-FUNC

BIT_OR_SYMBOL
    : B I T '_' O R                                                                       { self.doBitOr(); }
    ;                                                                                     // MYSQL-FUNC
...
CURRENT_DATE_SYMBOL
    : C U R R E N T '_' D A T E                                                           { self.doCurrentDate(); }
    ;                                                                                     // Synonym, MYSQL-FUNC

CURRENT_TIME_SYMBOL
    : C U R R E N T '_' T I M E                                                           { self.doCurrentTime(); }
    ;                                                                                     // Synonym, MYSQL-FUNC
...
DATE_ADD_SYMBOL
    : D A T E '_' A D D                                                                   { self.doDateAdd(); }
    ;

DATE_SUB_SYMBOL
    : D A T E '_' S U B                                                                   { self.doDateSub(); }
    ;
...
GROUP_CONCAT_SYMBOL
    : G R O U P '_' C O N C A T                                                           { self.doGroupConcat(); }
    ;
...
MASTER_AUTO_POSITION_SYMBOL
    : M A S T E R '_' A U T O '_' P O S I T I O N                                         {self.isServerVersionLt80024()}?
    ;

MASTER_BIND_SYMBOL
    : M A S T E R '_' B I N D                                                             {self.isServerVersionLt80024()}?
    ;

MASTER_CONNECT_RETRY_SYMBOL
    : M A S T E R '_' C O N N E C T '_' R E T R Y                                         {self.isServerVersionLt80024()}?
    ;

MASTER_DELAY_SYMBOL
    : M A S T E R '_' D E L A Y                                                           {self.isServerVersionLt80024()}?
    ;

MASTER_HOST_SYMBOL
    : M A S T E R '_' H O S T                                                             {self.isServerVersionLt80024()}?
    ;

MASTER_LOG_FILE_SYMBOL
    : M A S T E R '_' L O G '_' F I L E                                                   {self.isServerVersionLt80024()}?
    ;

MASTER_LOG_POS_SYMBOL
    : M A S T E R '_' L O G '_' P O S                                                     {self.isServerVersionLt80024()}?
    ;

MASTER_PASSWORD_SYMBOL
    : M A S T E R '_' P A S S W O R D                                                     {self.isServerVersionLt80024()}?
    ;

MASTER_PORT_SYMBOL
    : M A S T E R '_' P O R T                                                             {self.isServerVersionLt80024()}?
    ;

MASTER_RETRY_COUNT_SYMBOL
    : M A S T E R '_' R E T R Y '_' C O U N T                                             {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_CAPATH_SYMBOL
    : M A S T E R '_' S S L '_' C A P A T H                                               {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_CA_SYMBOL
    : M A S T E R '_' S S L '_' C A                                                       {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_CERT_SYMBOL
    : M A S T E R '_' S S L '_' C E R T                                                   {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_CIPHER_SYMBOL
    : M A S T E R '_' S S L '_' C I P H E R                                               {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_CRL_SYMBOL
    : M A S T E R '_' S S L '_' C R L                                                     {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_CRLPATH_SYMBOL
    : M A S T E R '_' S S L '_' C R L P A T H                                             {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_KEY_SYMBOL
    : M A S T E R '_' S S L '_' K E Y                                                     {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_SYMBOL
    : M A S T E R '_' S S L                                                               {self.isServerVersionLt80024()}?
    ;

MASTER_SSL_VERIFY_SERVER_CERT_SYMBOL
    : M A S T E R '_' S S L '_' V E R I F Y '_' S E R V E R '_' C E R T                   {self.isServerVersionLt80024()}?
    ;

MASTER_SYMBOL
    : M A S T E R                                                                         {self.isServerVersionLt80024()}?
    ;

MASTER_TLS_VERSION_SYMBOL
    : M A S T E R '_' T L S '_' V E R S I O N                                             {self.isServerVersionLt80024()}?
    ;

MASTER_USER_SYMBOL
    : M A S T E R '_' U S E R                                                             {self.isServerVersionLt80024()}?
    ;

MASTER_HEARTBEAT_PERIOD_SYMBOL
    : M A S T E R '_' H E A R T B E A T '_' P E R I O D                                   {self.isServerVersionLt80024()}?
    ;
...
POSITION_SYMBOL
    : P O S I T I O N                                                                     { self.doPosition(); }
    ;                                                                                     // SQL-2003-N
...
SESSION_USER_SYMBOL
    : S E S S I O N '_' U S E R                                                           { self.doSessionUser(); }
    ;                                                                                     // Synonym
...
STDDEV_SAMP_SYMBOL
    : S T D D E V '_' S A M P                                                             { self.doStddevSamp(); }
    ;                                                                                     // SQL-2003-N

STDDEV_SYMBOL
    : S T D D E V                                                                         { self.doStddev(); }
    ;                                                                                     // Synonym

STDDEV_POP_SYMBOL
    : S T D D E V '_' P O P                                                               { self.doStddevPop(); }
    ;                                                                                     // Synonym
...
SUBSTR_SYMBOL
    : S U B S T R                                                                         { self.doSubstr(); }
    ;                                                                                     // Synonym

SUBSTRING_SYMBOL
    : S U B S T R I N G                                                                   { self.doSubstring(); }
    ;                                                                                     // SQL-2003-N
...
SYSDATE_SYMBOL
    : S Y S D A T E                                                                       { self.doSysdate(); }
    ;

SYSTEM_USER_SYMBOL
    : S Y S T E M '_' U S E R                                                             { self.doSystemUser(); }
    ;
...
UDF_RETURNS_SYMBOL
    : U D F '_' R E T U R N S                                                             {self.isServerVersionLt80031()}?
    ;
...
VARIANCE_SYMBOL
    : V A R I A N C E                                                                     { self.doVariance(); }
    ;
...
VAR_POP_SYMBOL
    : V A R '_' P O P                                                                     { self.doVarPop(); }
    ;                                                                                     // Synonym

VAR_SAMP_SYMBOL
    : V A R '_' S A M P                                                                   { self.doVarSamp(); }
    ;
...
REMOTE_SYMBOL
    : R E M O T E                                                                         {self.isServerVersionLt80014()}?
    ;                                                                                     // MYSQL
...
GET_MASTER_PUBLIC_KEY_SYMBOL
    : G E T '_' M A S T E R '_' P U B L I C '_' K E Y '_' S Y M                           {self.isServerVersionLt80024()}?
    ;                                                                                     // MYSQL

RESTART_SYMBOL
    : R E S T A R T                                                                       {self.isServerVersionGe80011()}?
    ;                                                                                     // SQL-2003-N

DEFINITION_SYMBOL
    : D E F I N I T I O N                                                                 {self.isServerVersionGe80011()}?
    ;                                                                                     // MYSQL

DESCRIPTION_SYMBOL
    : D E S C R I P T I O N                                                               {self.isServerVersionGe80011()}?
    ;                                                                                     // MYSQL

ORGANIZATION_SYMBOL
    : O R G A N I Z A T I O N                                                             {self.isServerVersionGe80011()}?
    ;                                                                                     // MYSQL

REFERENCE_SYMBOL
    : R E F E R E N C E                                                                   {self.isServerVersionGe80011()}?
    ;                                                                                     // MYSQL

OPTIONAL_SYMBOL
    : O P T I O N A L                                                                     {self.isServerVersionGe80013()}?
    ;                                                                                     // MYSQL

SECONDARY_SYMBOL
    : S E C O N D A R Y                                                                   {self.isServerVersionGe80016()}?
    ;                                                                                     // MYSQL

SECONDARY_ENGINE_SYMBOL
    : S E C O N D A R Y '_' E N G I N E                                                   {self.isServerVersionGe80013()}?
    ;                                                                                     // MYSQL

SECONDARY_LOAD_SYMBOL
    : S E C O N D A R Y '_' L O A D                                                       {self.isServerVersionGe80013()}?
    ;                                                                                     // MYSQL

SECONDARY_UNLOAD_SYMBOL
    : S E C O N D A R Y '_' U N L O A D                                                   {self.isServerVersionGe80013()}?
    ;                                                                                     // MYSQL

ACTIVE_SYMBOL
    : A C T I V E                                                                         {self.isServerVersionGe80014()}?
    ;                                                                                     // MYSQL

INACTIVE_SYMBOL
    : I N A C T I V E                                                                     {self.isServerVersionGe80014()}?
    ;                                                                                     // MYSQL

LATERAL_SYMBOL
    : L A T E R A L                                                                       {self.isServerVersionGe80014()}?
    ;                                                                                     // SQL-2003-R

RETAIN_SYMBOL
    : R E T A I N                                                                         {self.isServerVersionGe80014()}?
    ;                                                                                     // MYSQL

OLD_SYMBOL
    : O L D                                                                               {self.isServerVersionGe80014()}?
    ;                                                                                     // SQL-2003-R

NETWORK_NAMESPACE_SYMBOL
    : N E T W O R K '_' N A M E S P A C E                                                 {self.isServerVersionGe80017()}?
    ;                                                                                     // MYSQL

ENFORCED_SYMBOL
    : E N F O R C E D                                                                     {self.isServerVersionGe80017()}?
    ;                                                                                     // SQL-2003-N

ARRAY_SYMBOL
    : A R R A Y                                                                           {self.isServerVersionGe80017()}?
    ;                                                                                     // SQL-2003-R

OJ_SYMBOL
    : O J                                                                                 {self.isServerVersionGe80017()}?
    ;                                                                                     // ODBC

MEMBER_SYMBOL
    : M E M B E R                                                                         {self.isServerVersionGe80017()}?
    ;                                                                                     // SQL-2003-R

RANDOM_SYMBOL
    : R A N D O M                                                                         {self.isServerVersionGe80018()}?
    ;                                                                                     // MYSQL

MASTER_COMPRESSION_ALGORITHM_SYMBOL
    : M A S T E R '_' C O M P R E S S I O N '_' A L G O R I T H M                         {self.isMasterCompressionAlgorithm()}?
    ;                                                                                     // MYSQL

MASTER_ZSTD_COMPRESSION_LEVEL_SYMBOL
    : M A S T E R '_' Z S T D '_' C O M P R E S S I O N '_' L E V E L                     {self.serverVersion >= 80018}?
    ;                                                                                     // MYSQL

PRIVILEGE_CHECKS_USER_SYMBOL
    : P R I V I L E G E '_' C H E C K S '_' U S E R                                       {self.serverVersion >= 80018}?
    ;                                                                                     // MYSQL

MASTER_TLS_CIPHERSUITES_SYMBOL
    : M A S T E R '_' T L S '_' C I P H E R S U I T E S                                   {self.serverVersion >= 80018}?
    ;                                                                                     // MYSQL

REQUIRE_ROW_FORMAT_SYMBOL
    : R E Q U I R E '_' R O W '_' F O R M A T                                             {self.serverVersion >= 80019}?
    ;                                                                                     // MYSQL

PASSWORD_LOCK_TIME_SYMBOL
    : P A S S W O R D '_' L O C K '_' T I M E                                             {self.serverVersion >= 80019}?
    ;                                                                                     // MYSQL

FAILED_LOGIN_ATTEMPTS_SYMBOL
    : F A I L E D '_' L O G I N '_' A T T E M P T S                                       {self.serverVersion >= 80019}?
    ;                                                                                     // MYSQL

REQUIRE_TABLE_PRIMARY_KEY_CHECK_SYMBOL
    : R E Q U I R E '_' T A B L E '_' P R I M A R Y '_' K E Y '_' C H E C K               {self.serverVersion >= 80019}?
    ;                                                                                     // MYSQL

STREAM_SYMBOL
    : S T R E A M                                                                         {self.serverVersion >= 80020}?
    ;                                                                                     // MYSQL

OFF_SYMBOL
    : O F F                                                                               {self.serverVersion >= 80019}?
    ;                                                                                     // SQL-1999-R

RETURNING_SYMBOL
    : R E T U R N I N G                                                                   {self.isServerVersionGe80021()}?
    ;                                                                                     // SQL-2016-N

JSON_VALUE_SYMBOL
    : J S O N '_' V A L U E                                                               {self.isServerVersionGe80024()}?
    ;                                                                                     // SQL-2016-R

TLS_SYMBOL
    : T L S                                                                               {self.isServerVersionGe80021()}?
    ;                                                                                     // MYSQL

ATTRIBUTE_SYMBOL
    : A T T R I B U T E                                                                   {self.isServerVersionGe80024()}?
    ;                                                                                     // SQL-2003-N

ENGINE_ATTRIBUTE_SYMBOL
    : E N G I N E '_' A T T R I B U T E                                                   {self.isServerVersionGe80024()}?
    ;                                                                                     // MYSQL

SECONDARY_ENGINE_ATTRIBUTE_SYMBOL
    : S E C O N D A R Y '_' E N G I N E '_' A T T R I B U T E                             {self.isServerVersionGe80024()}?
    ;                                                                                     // MYSQL

SOURCE_CONNECTION_AUTO_FAILOVER_SYMBOL
    : S O U R C E '_' C O N N E C T I O N '_' A U T O '_' F A I L O V E R                 {self.isServerVersionGe80024()}?
    ;                                                                                     // MYSQL

ZONE_SYMBOL
    : Z O N E                                                                             {self.isServerVersionGe80022()}?
    ;                                                                                     // SQL-2003-N

GRAMMAR_SELECTOR_DERIVED_EXPR
    : G R A M M A R '_' S E L E C T O R '_' D E R I V E D                                 {self.isServerVersionGe80024()}?
    ;                                                                                     // synthetic token: starts derived table expressions.

REPLICA_SYMBOL
    : R E P L I C A                                                                       {self.isServerVersionGe80022()}?
    ;

REPLICAS_SYMBOL
    : R E P L I C A S                                                                     {self.isServerVersionGe80022()}?
    ;

ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL
    : A S S I G N '_' G T I D S '_' T O '_' A N O N Y M O U S '_' T R A N S A C T I O N S {self.isServerVersionGe80024()}?
    ;                                                                                     // MYSQL

GET_SOURCE_PUBLIC_KEY_SYMBOL
    : G E T '_' S O U R C E '_' P U B L I C '_' K E Y                                     {self.isServerVersionGe80024()}?
    ;                                                                                     // MYSQL

SOURCE_AUTO_POSITION_SYMBOL
    : S O U R C E '_' A U T O '_' P O S I T I O N                                         {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_BIND_SYMBOL
    : S O U R C E '_' B I N D                                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_COMPRESSION_ALGORITHM_SYMBOL
    : S O U R C E '_' C O M P R E S S I O N '_' A L G O R I T H M                         {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_CONNECT_RETRY_SYMBOL
    : S O U R C E '_' C O N N E C T '_' R E T R Y                                         {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_DELAY_SYMBOL
    : S O U R C E '_' D E L A Y                                                           {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_HEARTBEAT_PERIOD_SYMBOL
    : S O U R C E '_' H E A R T B E A T '_' P E R I O D                                   {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_HOST_SYMBOL
    : S O U R C E '_' H O S T                                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_LOG_FILE_SYMBOL
    : S O U R C E '_' L O G '_' F I L E                                                   {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_LOG_POS_SYMBOL
    : S O U R C E '_' L O G '_' P O S                                                     {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_PASSWORD_SYMBOL
    : S O U R C E '_' P A S S W O R D                                                     {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_PORT_SYMBOL
    : S O U R C E '_' P O R T                                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_PUBLIC_KEY_PATH_SYMBOL
    : S O U R C E '_' P U B L I C '_' K E Y '_' P A T H                                   {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_RETRY_COUNT_SYMBOL
    : S O U R C E '_' R E T R Y '_' C O U N T                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_SYMBOL
    : S O U R C E '_' S S L                                                               {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CA_SYMBOL
    : S O U R C E '_' S S L '_' C A                                                       {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CAPATH_SYMBOL
    : S O U R C E '_' S S L '_' C A P A T H                                               {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CERT_SYMBOL
    : S O U R C E '_' S S L '_' C E R T                                                   {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CIPHER_SYMBOL
    : S O U R C E '_' S S L '_' C I P H E R                                               {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CRL_SYMBOL
    : S O U R C E '_' S S L '_' C R L                                                     {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_SSL_CRLPATH_SYMBOL
    : S O U R C E '_' S S L '_' C R L P A T H                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL
...
SOURCE_SSL_VERIFY_SERVER_CERT_SYMBOL
    : S O U R C E '_' S S L '_' V E R I F Y '_' S E R V E R '_' C E R T                   {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_TLS_CIPHERSUITES_SYMBOL
    : S O U R C E '_' T L S '_' C I P H E R S U I T E S                                   {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_TLS_VERSION_SYMBOL
    : S O U R C E '_' T L S '_' V E R S I O N                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_USER_SYMBOL
    : S O U R C E '_' U S E R                                                             {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

SOURCE_ZSTD_COMPRESSION_LEVEL_SYMBOL
    : S O U R C E '_' Z S T D '_' C O M P R E S S I O N '_' L E V E L                     {self.isServerVersionGe80023()}?
    ;                                                                                     // MYSQL

ST_COLLECT_SYMBOL
    : S T '_' C O L L E C T                                                               {self.serverVersion >= 80025}?
    ;                                                                                     // MYSQL

KEYRING_SYMBOL
    : K E Y R I N G                                                                       {self.serverVersion >= 80025}?
    ;                                                                                     // MYSQL

AUTHENTICATION_SYMBOL
    : A U T H E N T I C A T I O N                                                         {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

FACTOR_SYMBOL
    : F A C T O R                                                                         {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

FINISH_SYMBOL
    : F I N I S H                                                                         {self.serverVersion >= 80027}?
    ;                                                                                     // SQL-2016-N

INITIATE_SYMBOL
    : I N I T I A T E                                                                     {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

REGISTRATION_SYMBOL
    : R E G I S T R A T I O N                                                             {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

UNREGISTER_SYMBOL
    : U N R E G I S T E R                                                                 {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

INITIAL_SYMBOL
    : I N I T I A L                                                                       {self.serverVersion >= 80027}?
    ;                                                                                     // SQL-2016-R

CHALLENGE_RESPONSE_SYMBOL
    : C H A L L E N G E '_' R E S P O N S E                                               {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

GTID_ONLY_SYMBOL
    : G T I D '_' O N L Y                                                                 {self.serverVersion >= 80027}?
    ;                                                                                     // MYSQL

INTERSECT_SYMBOL
    : I N T E R S E C T '_' S Y M B O L                                                   {self.serverVersion >= 80031}?
    ;                                                                                     // SQL-1992-R

BULK_SYMBOL
    : B U L K                                                                             {self.serverVersion >= 80032}?
    ;                                                                                     // MYSQL

URL_SYMBOL
    : U R L                                                                               {self.serverVersion >= 80032}?
    ;                                                                                     // MYSQL

GENERATE_SYMBOL
    : G E N E R A T E                                                                     {self.serverVersion >= 80032}?
    ;                                                                                     // MYSQL

PARSE_TREE_SYMBOL
    : P A R S E '_' T R E E                                                               {self.serverVersion >= 80100}?
    ;                                                                                     // MYSQL

LOG_SYMBOL
    : L O G                                                                               {self.serverVersion >= 80032}?
    ;                                                                                     // MYSQL

GTIDS_SYMBOL
    : G T I D S                                                                           {self.serverVersion >= 80032}?
    ;                                                                                     // MYSQL

PARALLEL_SYMBOL
    : P A R A L L E L                                                                     {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL

S3_SYMBOL
    : S '3'                                                                               {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL

QUALIFY_SYMBOL
    : Q U A L I F Y                                                                       {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL

AUTO_SYMBOL
    : A U T O                                                                             {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL

MANUAL_SYMBOL
    : M A N U A L                                                                         {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL

BERNOULLI_SYMBOL
    : B E R N O U L L I                                                                   {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL

TABLESAMPLE_SYMBOL
    : T A B L E S A M P L E                                                               {self.serverVersion >= 80200}?
    ;                                                                                     // MYSQL
...
UNDERSCORE_CHARSET
    : UNDERLINE_SYMBOL [a-z0-9]+ { self.doUnderscoreCharset(); }
    ;

// TODO: check in the semantic phase that starting and ending tags are the same.
DOLLAR_QUOTED_STRING_TEXT
   : '$' DOLLAR_QUOTE_TAG_CHAR* '$' .*? '$' DOLLAR_QUOTE_TAG_CHAR* '$' {self.doDollarQuotedStringText()}?;
...
BACK_TICK_QUOTED_ID
    : BACK_TICK (({self.isBackTickQuotedId()}? '\\')? .)*? BACK_TICK
    ;

DOUBLE_QUOTED_TEXT
    : (
        DOUBLE_QUOTE (({self.isDoubleQuotedText()}? '\\')? .)*? DOUBLE_QUOTE
    )+
    ;

SINGLE_QUOTED_TEXT
    : (
        SINGLE_QUOTE (({self.isSingleQuotedText()}? '\\')? .)*? SINGLE_QUOTE
    )+
    ;
...
VERSION_COMMENT_START
    : ('/*!' DIGITS) (
        {self.isVersionComment()}? // Will set self.inVersionComment if the number matches.
        | .*? '*/'
    ) -> channel(HIDDEN)
    ;

// self.inVersionComment is a variable in the base lexer.
// TODO: use a lexer mode instead of a member variable.
MYSQL_COMMENT_START
    : '/*!' { self.startInVersionComment(); } -> channel(HIDDEN)
    ;

VERSION_COMMENT_END
    : '*/' {self.isInVersionComment()}?
      { self.endInVersionComment(); } -> channel(HIDDEN)
    ;
