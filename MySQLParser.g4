...
alterStatement
    : ALTER_SYMBOL (
        ...
        | alterEvent
        | alterTablespace
        | {self.isServerVersionGe80014()}? alterUndoTablespace
        | alterLogfileGroup
        | alterServer
...
alterListItem
    ...
    | DROP_SYMBOL (
        ...
        | keyOrIndex indexRef
        | {self.isServerVersionGe80017()}? CHECK_SYMBOL identifier
        | {self.isServerVersionGe80019()}? CONSTRAINT_SYMBOL identifier
    )
    | DISABLE_SYMBOL KEYS_SYMBOL
    | ENABLE_SYMBOL KEYS_SYMBOL
    | ALTER_SYMBOL COLUMN_SYMBOL? columnInternalRef (
        SET_SYMBOL DEFAULT_SYMBOL (
            {self.isServerVersionGe80014()}? exprWithParentheses
            | signedLiteralOrNull
        )
        | DROP_SYMBOL DEFAULT_SYMBOL
        | {self.isServerVersionGe80024()}? SET_SYMBOL visibility
    )
    | ALTER_SYMBOL INDEX_SYMBOL indexRef visibility
    | {self.isServerVersionGe80017()}? ALTER_SYMBOL CHECK_SYMBOL identifier constraintEnforcement
    | {self.isServerVersionGe80019()}? ALTER_SYMBOL CONSTRAINT_SYMBOL identifier constraintEnforcement
    ...
    | CONVERT_SYMBOL TO_SYMBOL charset (
        {self.isServerVersionGe80014()}? DEFAULT_SYMBOL
        | charsetName
    ) collate?
    | FORCE_SYMBOL
...
alterTablespace
    : TABLESPACE_SYMBOL tablespaceRef (
        ...
        | RENAME_SYMBOL TO_SYMBOL identifier
        | {self.isServerVersionGe80014()}? alterTablespaceOptions
    )
    ;
...
alterTablespaceOption
    ...
    | tsOptionWait
    | tsOptionEncryption
    | {self.isServerVersionGe80024()}? tsOptionEngineAttribute
    ;
...
createStatement
    : CREATE_SYMBOL (
        ...
        | createEvent
        | createRole
        | {self.isServerVersionGe80011()}? createSpatialReference
        | {self.isServerVersionGe80014()}? createUndoTablespace
    )
    ;
...
createDatabaseOption
    : defaultCharset
    | defaultCollation
    | {self.isServerVersionGe80016()}? defaultEncryption
    ;
...
storedRoutineBody
    : compoundStatement
    | {self.isStoredRoutineBody()}? AS_SYMBOL routineString
    ;
...
routineOption
    ...
    | option = LANGUAGE_SYMBOL (
        SQL_SYMBOL
        | {self.isServerVersionGe80032()}? identifier
    )
...
tsDataFileName
    ...
    | {self.isServerVersionGe80014()}? (ADD_SYMBOL tsDataFile)? // now optional
    ;
...
tablespaceOption
    ...
    | {self.isServerVersionGe80014()}? tsOptionEncryption
    ;
...
dropStatement
    : DROP_SYMBOL (
        ...
        | dropView
        | dropRole
        | {self.isServerVersionGe80011()}? dropSpatialReference
        | {self.isServerVersionGe80014()}? dropUndoTablespace
    )
    ;
...
deleteStatement
    : withClause? DELETE_SYMBOL deleteStatementOption* (
        FROM_SYMBOL (
            ...
            | tableRef ({self.isServerVersionGe80017()}? tableAlias)? partitionDelete? whereClause? orderClause? simpleLimitClause?
            // Single table delete.
        )
...
valuesReference
    : {self.isServerVersionGe80018()}? AS_SYMBOL identifier columnInternalRefList?
    ;
...
loadFrom
    : {self.isServerVersionGe80200()}? FROM_SYMBOL
    ;

loadSourceType
    : INFILE_SYMBOL
    | {self.isServerVersionGe80200()}? (URL_SYMBOL | S3_SYMBOL)
    ;

sourceCount
    : {self.isServerVersionGe80200()}? (
...
sourceOrder
    : {self.isServerVersionGe80200()}? IN_SYMBOL PRIMARY_SYMBOL KEY_SYMBOL ORDER_SYMBOL
    ;
...
loadAlgorithm
    : {self.isServerVersionGe80200()}? ALGORITHM_SYMBOL EQUAL_OPERATOR BULK_SYMBOL
    ;

loadParallel
    : {self.isServerVersionGe80200()}? PARALLEL_SYMBOL EQUAL_OPERATOR INT_NUMBER
    ;

loadMemory
    : {self.isServerVersionGe80200()}? MEMORY_SYMBOL EQUAL_OPERATOR sizeNumber
    ;
...
selectStatementWithInto
    ...
    | {self.isSelectStatementWithInto()}? queryExpressionParens intoClause
    ;
...
queryExpressionBody
    ...
    (
        (
            UNION_SYMBOL
            | {self.isServerVersionGe80031()}? (EXCEPT_SYMBOL | INTERSECT_SYMBOL)
...
queryPrimary
    : querySpecification
    | {self.isServerVersionGe80019()}? tableValueConstructor
    | {self.isServerVersionGe80019()}? explicitTable
    ;
...
qualifyClause
    : {self.isServerVersionGe80200()}? QUALIFY_SYMBOL expr
    ;
...
groupByClause
    ...
    | {self.isServerVersionGe80032()}? GROUP_SYMBOL BY_SYMBOL (
        ROLLUP_SYMBOL
        | CUBE_SYMBOL
...
lockingClauseList
    : {self.isServerVersionGe80031()}? lockingClause+
    ;
...
tableReference
    ...
    (
        tableFactor
        // ODBC syntax
        | OPEN_CURLY_SYMBOL ({self.isServerVersionGe80017()}? identifier | OJ_SYMBOL) escapedTableReference CLOSE_CURLY_SYMBOL
    ) joinedTable*
    ;
...
tableFactor
    ...
    | {self.isServerVersionGe80004()}? tableFunction
    ;
...
derivedTable
    ...
    | {self.isServerVersionGe80014()}? LATERAL_SYMBOL subquery tableAlias? columnInternalRefList?
    ;
...
jtColumn
    ...
    | identifier dataType ({self.isServerVersionGe80014()}? collate)? EXISTS_SYMBOL? PATH_SYMBOL textStringLiteral
...
tableAlias
    : (AS_SYMBOL | {self.isServerVersionGe80017()}? EQUAL_OPERATOR)? identifier
    ;
...
masterOrBinaryLogsAndGtids
    : MASTER_SYMBOL
    | {self.isServerVersionGe80032()}? BINARY_SYMBOL LOGS_SYMBOL AND_SYMBOL GTIDS_SYMBOL
    ;
...
changeReplicationSource
    : MASTER_SYMBOL
    | {self.isServerVersionGe80024()}? REPLICATION_SYMBOL SOURCE_SYMBOL
    ;
...
sourceDefinition
    ...
    | {self.isServerVersionGe80024()}? SOURCE_CONNECTION_AUTO_FAILOVER_SYMBOL EQUAL_OPERATOR real_ulong_number
    | {self.isServerVersionGe80024()}? ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL EQUAL_OPERATOR
        assignGtidsToAnonymousTransactionsDefinition
    | {self.isServerVersionGe80027()}? GTID_ONLY_SYMBOL EQUAL_OPERATOR real_ulong_number
    | sourceFileDef
    ;
...
cloneStatement
    : CLONE_SYMBOL (
        ...
        | {self.isServerVersionGe80014()}? INSTANCE_SYMBOL FROM_SYMBOL user COLON_SYMBOL ulong_number IDENTIFIED_SYMBOL BY_SYMBOL
...
alterUserStatement
    : ALTER_SYMBOL USER_SYMBOL ifExists? (
        (
            {self.isServerVersionGe80014()}? createUserList
            | {self.isServerVersionGe80014()}? alterUserList
        ) createUserTail
        | userFunction (
...
alterUser
    : {self.isServerVersionLt80025()}? oldAlterUser
    | {self.isServerVersionGe80025()}? (
        user (
...
createUserTail
    : requireClause? connectOptions? accountLockPasswordExpireOptions* (
        {self.isServerVersionGe80024()}? userAttributes
    )?
    ;
...
accountLockPasswordExpireOptions
    ...
    | PASSWORD_SYMBOL (
        ...
        | {self.isServerVersionGe80014()}? REQUIRE_SYMBOL CURRENT_SYMBOL (
            DEFAULT_SYMBOL
            | OPTIONAL_SYMBOL
        )?
    )
...
grantTargetList
    : {self.isServerVersionLt80011()}? createUserList
    | {self.isServerVersionGe80011()}? userList
    ;
...
versionedRequireClause
    : {self.isServerVersionLt80011()}? requireClause
    ;
...
revokeStatement
    : REVOKE_SYMBOL ({self.isServerVersionGe80031()}? ifExists)? (
    ...
    ) ({self.isServerVersionGe80031()}? ignoreUnknownUser)?
    ;
...
grantIdentifier
    ...
    | tableRef
    | {self.isServerVersionGe80017()}? schemaRef DOT_SYMBOL tableRef
    ;
...
histogramAutoUpdate
    : {self.isServerVersionGe80200()}? (MANUAL_SYMBOL | AUTO_SYMBOL) UPDATE_SYMBOL
    ;

histogramUpdateParam
    : histogramNumBuckets? histogramAutoUpdate?
    | {self.isServerVersionGe80031()}? USING_SYMBOL DATA_SYMBOL textStringLiteral
    ;

histogramNumBuckets
    : {self.isServerVersionGe80200()}? WITH_SYMBOL INT_NUMBER BUCKETS_SYMBOL
    ;
...
installSetValueList
    : {self.isServerVersionGe80032()}? SET_SYMBOL installSetValue (
...
startOptionValueList
    ...
    | PASSWORD_SYMBOL (FOR_SYMBOL user)? equal (
        ...
        | textString replacePassword? retainCurrentPassword?
        | {self.isServerVersionLt80014()}? PASSWORD_SYMBOL OPEN_PAR_SYMBOL textString CLOSE_PAR_SYMBOL
    )
    | {self.isServerVersionGe80018()}? PASSWORD_SYMBOL (FOR_SYMBOL user)? TO_SYMBOL RANDOM_SYMBOL replacePassword?
        retainCurrentPassword?
    ;
...
optionValueNoOptionType
    ...
    | NAMES_SYMBOL (
        equal expr
        | charsetName collate?
        | {self.isServerVersionGe80011()}? DEFAULT_SYMBOL
    )
    ;
...
showParseTreeStatement
    : {self.isServerVersionGe80100()}? SHOW_SYMBOL PARSE_TREE_SYMBOL simpleStatement
    ;
...
utilityStatement
    ...
    | helpCommand
    | useCommand
    | {self.isServerVersionGe80011()}? restartServer
    ;
...
explainStatement
    : (EXPLAIN_SYMBOL | DESCRIBE_SYMBOL | DESC_SYMBOL) explainOptions? (
        {self.isServerVersionGe80032()}? FOR_SYMBOL DATABASE_SYMBOL textOrIdentifier
    )? explainableStatement
    ;

explainOptions
    : FORMAT_SYMBOL EQUAL_OPERATOR textOrIdentifier (
        {self.isServerVersionGe80032()}? explainInto
    )?
    | {self.isServerVersionLt80012()}? EXTENDED_SYMBOL
    | {self.isServerVersionGe80018()}? ANALYZE_SYMBOL
    | {self.isServerVersionGe80019()}? ANALYZE_SYMBOL FORMAT_SYMBOL EQUAL_OPERATOR textOrIdentifier
    ;
...
predicate
    : bitExpr (
        ...
        | {self.isServerVersionGe80017()}? MEMBER_SYMBOL OF_SYMBOL? simpleExprWithParentheses
...
arrayCast
    : {self.isServerVersionGe80017()}? ARRAY_SYMBOL
    ;
...
windowFunctionCall
    ...
    | NTILE_SYMBOL (
        ...
        | {self.isServerVersionLt80024()}? simpleExprWithParentheses
    ) windowingClause
...
tablesampleClause
    : {self.isServerVersionGe80200()}? TABLESAMPLE_SYMBOL samplingMethod OPEN_PAR_SYMBOL samplingPercentage CLOSE_PAR_SYMBOL
    ;
...
leadLagInfo
    : COMMA_SYMBOL (
        ulonglongNumber
        | PARAM_MARKER
        | {self.isServerVersionGe80024()}? stableInteger
    ) (COMMA_SYMBOL expr)?
    ;
...
runtimeFunctionCall
    ...
    | {self.isServerVersionGe80032()}? LOG_SYMBOL OPEN_PAR_SYMBOL expr (
        COMMA_SYMBOL expr
    )? CLOSE_PAR_SYMBOL
    ...
    | {self.isServerVersionLt80011()}? PASSWORD_SYMBOL exprWithParentheses
...
lvalueVariable
    : (
        ...
        | {self.isServerVersionGe80017()}? lValueIdentifier dotIdentifier?
    )
...
castType
    ...
    | DATE_SYMBOL
    | {self.isServerVersionGe80024()}? YEAR_SYMBOL
    | TIME_SYMBOL typeDatetimePrecision?
    | DATETIME_SYMBOL typeDatetimePrecision?
    | DECIMAL_SYMBOL floatOptions?
    | JSON_SYMBOL
    | {self.isServerVersionGe80017()}? realType
    | {self.isServerVersionGe80017()}? FLOAT_SYMBOL standardFloatOptions?
    | {self.isServerVersionGe80027()}? (
        POINT_SYMBOL
        | LINESTRING_SYMBOL
        | POLYGON_SYMBOL
        | MULTIPOINT_SYMBOL
...
checkOrReferences
    : {self.isServerVersionLt80016()}? checkConstraint
    | references
    ;
...
constraintEnforcement
    : {self.isServerVersionGe80017()}? NOT_SYMBOL? ENFORCED_SYMBOL
    ;
...
columnAttribute
    ...
    | {self.isServerVersionGe80014()}? NOT_SYMBOL SECONDARY_SYMBOL
    | value = DEFAULT_SYMBOL (
        nowOrSignedLiteral
        | {self.isServerVersionGe80013()}? exprWithParentheses
    )
    ...
    | {self.isServerVersionGe80017()}? constraintName? checkConstraint
    | {self.isServerVersionGe80017()}? constraintEnforcement
    | {self.isServerVersionGe80024()}? value = ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    | {self.isServerVersionGe80024()}? value = SECONDARY_ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    | {self.isServerVersionGe80024()}? visibility
    ;
...
keyPartOrExpression
    ...
    keyPart
    | {self.isServerVersionGe80013()}? exprWithParentheses direction?
    ;
...
commonIndexOption
    ...
    | COMMENT_SYMBOL textLiteral
    | visibility
    | {self.isServerVersionGe80024()}? ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    | {self.isServerVersionGe80024()}? SECONDARY_ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    ;
...
charsetName
    : textOrIdentifier
    | BINARY_SYMBOL
    | {self.isServerVersionLt80011()}? DEFAULT_SYMBOL
    ;

collationName
    : textOrIdentifier
    | {self.isServerVersionLt80011()}? DEFAULT_SYMBOL
    | {self.isServerVersionGe80018()}? BINARY_SYMBOL
    ;
...
createTableOption
    ...
    | {self.isServerVersionGe80014()}? option = SECONDARY_ENGINE_SYMBOL equal? (
        NULL_SYMBOL
        | textOrIdentifier
    )
    ...
    | {self.isServerVersionGe80024()}? option = START_SYMBOL TRANSACTION_SYMBOL
    | {self.isServerVersionGe80024()}? option = ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    | {self.isServerVersionGe80024()}? option = SECONDARY_ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    | {self.isServerVersionGe80024()}? tsOptionAutoextendSize
    ;
...
pureIdentifier
    ...
    | {self.isPureIdentifier()}? DOUBLE_QUOTED_TEXT
    ;
...
real_ulonglong_number
    : INT_NUMBER
    | {self.isServerVersionGe80017()}? HEX_NUMBER
    | ULONGLONG_NUMBER
    | LONG_NUMBER
    ;
...
signedLiteralOrNull
    : signedLiteral
    | {self.isServerVersionGe80024()}? nullAsLiteral
    ;
...
textStringLiteral
    ...
    | {self.isTextStringLiteral()}? value = DOUBLE_QUOTED_TEXT
    ;
...
roleKeyword
    : {self.isServerVersionLt80017()}? (roleOrLabelKeyword | roleOrIdentifierKeyword)
    | (
        identifierKeywordsUnambiguous
        | identifierKeywordsAmbiguous2Labels
        | identifierKeywordsAmbiguous4SystemVariables
...
roleOrLabelKeyword
    ...
    | {self.isServerVersionGe80014()}? ADMIN_SYMBOL
    ;
