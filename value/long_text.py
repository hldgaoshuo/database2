...
class LongText(Value):
    ...
    def __init__(self, content: str) -> None:
        ...
        super().__init__(ValueType.LONG_TEXT, content)
...
def new_long_text(content: str) -> LongText:
    return LongText(content)


def new_long_text_from_bytes(buf: BytesIO) -> LongText:
